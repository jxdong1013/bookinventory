...
namespace bookweb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    if (ModelState.IsValid)
        //    {
        //        var user = new ApplicationUser { PhoneNumber= model.PhoneNumber , UserName = model.UserName , Email = model.Email , Id= System.Guid.NewGuid().ToString()};
        ...
        //            //var roleresult = await UserManager.AddToRolesAsync(user.Id, new[] { "admin", "manager" });
