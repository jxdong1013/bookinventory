...
    {
        static string SqlConnectionString = ConfigurationManager.ConnectionStrings["SqlServerString"].ConnectionString;
         
        /// <summary>
        /// 设置参数内容
        /// </summary>
...
        }
        ...
        public static DataSet ExecuteDataSet(string commandText , CommandType commandType , params SqlParameter[] commandParameters)
        {
            ...
            return ExecuteDataSet(ref outParameters , commandText, commandType, commandParameters);
        }
