...
public class BookSearchModel implements IBookSearchModel {
    ...
    @Override
    public void getBookList(BookBean key , Observer subscriber ) {
        Observable<DataBase<List<BookBean>>> observable = apiService.getBookList( key.getBookName(),key.getBookcode());
